...
data = pd.read_csv(
    ...
    encoding='utf-8',
    sep=',',
    usecols=['id', 'label', 'label_ga', 'wikidata_id', 'wkt'],
...
for index, row in data.iterrows():
    ...
    lines.append("ogham:GSD" + str(row['id']) + " " + "dct:rightsHolder" + " wd:Q85384744 .")  # townland-ie
    # prov-o
    ...
    lines.append("<https://github.com/ogi-ogham/ogham-datav1/blob/main/csv/geodata/" + file_name + ".csv> " + "prov:wasDerivedFrom" + " <https://www.townlands.ie/page/download/> .")
    lines.append("<https://github.com/ogi-ogham/ogham-datav1/blob/main/csv/geodata/" + file_name + ".csv> " + "prov:wasDerivedFrom" + " <https://data-osi.opendata.arcgis.com/datasets/baronies-osi-national-statutory-boundaries-generalised-20m?geometry=-29.156%2C51.112%2C12.658%2C55.691> .")
    lines.append("<https://github.com/ogi-ogham/ogham-datav1/blob/main/csv/geodata/" + file_name + ".csv> " + "prov:wasAttributedTo" + " wd:Q85384744 .")
    lines.append("<https://github.com/ogi-ogham/ogham-datav1/blob/main/csv/geodata/" + file_name + ".csv> " + "prov:wasAttributedTo" + " wd:Q3355441 .")
