...
for index, row in data.iterrows():
    ...
    # QS
    lines.append("CREATE")
    lines.append("LAST" + "\t" + "Len" + "\t" + "\"" + str(row["label"]) + " (Ogham Person)\"")
    lines.append("LAST" + "\t" + "Den" + "\t" + "\"a person mentioned in an inscription on an Ogham Stone\"")
    lines.append("LAST" + "\t" + "P31" + "\t" + "Q110897921")
    lines.append("LAST" + "\t" + "P361" + "\t" + "Q100530634")
    lines.append("LAST" + "\t" + "P361" + "\t" + "Q70873595")
    lines.append("LAST" + "\t" + "P2561" + "\t" + "ga:\"" + str(row["name_caps"]) + "\"")
    lines.append("LAST" + "\t" + "P2888" + "\t" + "\"http://lod.ogham.link/data/OP" + str(row["id"]) + "\"")
